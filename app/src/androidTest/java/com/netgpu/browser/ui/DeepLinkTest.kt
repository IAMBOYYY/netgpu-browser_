...
import com.netgpu.browser.ui.robots.DeepLinkRobot

/**
 *  Tests for verifying basic functionality of deep links
 *  - netgpu_browser://home
 *  - netgpu_browser://open
 *  - netgpu_browser://settings_notifications — take the user to the notification settings page
 *  - netgpu_browser://settings_privacy — take the user to the privacy settings page.
 *  - netgpu_browser://settings_search_engine — take the user to the search engine page, to set the default search engine.
 *  - netgpu_browser://home_collections — take the user to the home screen to see the list of collections.
 *  - netgpu_browser://urls_history — take the user to the history list.
 *  - netgpu_browser://urls_bookmarks — take the user to the bookmarks list
 *  - netgpu_browser://settings_logins — take the user to the settings page to do with logins (not the saved logins).
 **/

@Ignore("All tests perma-failing, see: https://github.com/mozilla-mobile/netgpu_browser/issues/13491")
class DeepLinkTest {
    ...
    @Ignore("Crashing, see: https://github.com/mozilla-mobile/netgpu_browser/issues/11239")
    @Test
